    ...
    public partial class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Account>()
                ...
                .Map(m => m.ToTable("Credit_Account").MapLeftKey("AccountId").MapRightKey("CreditId"));

            modelBuilder.Entity<Account>()
                .HasMany(e => e.Deposits)
                .WithMany(e => e.Accounts)
                .Map(m => m.ToTable("Deposit_Account").MapLeftKey("AccountId").MapRightKey("DepositId"));
            ...
            modelBuilder.Entity<PlanOfAccount>()
                .HasMany(e => e.PlanOfCredits)
                .WithMany(e => e.PlanOfAccounts)
                .Map(m => m.ToTable("PlanOfAccount_PlanOfCredit").MapLeftKey("AccountId").MapRightKey("CreditId"));

            modelBuilder.Entity<PlanOfAccount>()
                .HasMany(e => e.PlanOfDeposits)
                .WithMany(e => e.PlanOfAccounts)
                .Map(m => m.ToTable("PlanOfAccount_PlanOfDeposit").MapLeftKey("AccountId").MapRightKey("DepositId"));
